    ...
    <>
      <div className="seats-main-container">
        <div className="seats-header">
          ...
          <div
            className="seats-book"
            onClick={() => {
              const url =
                selectedCampus === "GLOBAL"
                  ? "https://lib.hufs.ac.kr/global/service/facility/seat/reading-rooms-for-assignment"
                  : "https://lib.hufs.ac.kr/service/facility/seat/reading-rooms-for-assignment";
              window.open(url);
            }}
          >
            <span>열람실 예약</span>
    ...
    <>
      <div className="seats-left">
        ...
        <span className="seats-num">
          <span className="seats-left-num">{seatsAvail}</span>/{seatsTotal}
        </span>
        <progress
          className="progress"
          value={seatsAvail}
